...
public class OrderController {
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam("order") String orderId,
    ...
    public ResponseEntity<String> deletePartnerById(@PathVariable String partnerId){
        ...
        //-->and the corresponding orders should be unassigned:
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        //-->and the corresponding partner should be unassigned
